...
internal class Program
{
    ...
    tryVote:
        ...
        {
            Console.WriteLine("Sistemde kayıtlı böyle bir kullanıcı bulunamadı. Kayıt ekranına yönlendiriliyorsunuz.");
        tryUserName:
            ...
            else
            {
                ...
                Console.WriteLine("Kayıt başarılı.Oylama ekranına yönlendiriliyorsunuz. Lütfen bir tuşa basınız.");
                Console.ReadKey();
                Console.Clear();
                goto tryVote;
            }
